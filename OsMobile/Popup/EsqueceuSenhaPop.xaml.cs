...
{
    public delegate void ButtonEsqueceuClickedHandler();
   

    public partial class EsqueceuSenhaPop : PopupPage
    {
        public event ButtonEsqueceuClickedHandler ButtonClicked;




    public EsqueceuSenhaPop()
        {
            InitializeComponent();
        ...
        public EsqueceuSenhaPop(string alerta)
        {
            InitializeComponent();
